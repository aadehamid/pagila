...
ALTER TABLE northwind.shippers_tmp OWNER TO postgres;
...
--
-- Name: northwind; Type: ACL; Schema: -; Owner: postgres
--

REVOKE ALL ON SCHEMA northwind FROM PUBLIC;
REVOKE ALL ON SCHEMA northwind FROM postgres;
